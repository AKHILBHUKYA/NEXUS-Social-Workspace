...
@IdClass(PostSave.PostSaveId.class)
public class PostSave {
    ...
    public static class PostSaveId implements Serializable {
        private Long postId; private Long userId;
        public PostSaveId() {}
        public PostSaveId(Long postId, Long userId) { this.postId = postId; this.userId = userId; }
        @Override public boolean equals(Object o) {
            if (this == o) return true;
            if (!(o instanceof PostSaveId that)) return false;
