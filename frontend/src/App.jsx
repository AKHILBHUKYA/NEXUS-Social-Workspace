    ...
    <div className="nexus" style={{ justifyContent: 'center', alignItems: 'center', minHeight: '100vh', padding: 24 }}>
      <div style={{
        ...
        <p style={{ color: '#727a78', fontSize: 12, marginBottom: 20 }}>
          {mode === 'login' ? 'Access your unified social command center.' : 'Join NEXUS — local workspace, not real social APIs.'}
        </p>
        ...
        {page === 'home' && (
          <div className="home">
            <div className="hero">
              ...
              <p>NEXUS unifies messaging, feeds, reels and AI — backed by your own database, not third-party social APIs.</p>
        ...
        {page === 'settings' && (
          <div className="post">
            ...
            <p style={{ marginTop: 16, fontSize: 11, color: '#4f5655' }}>
              NEXUS does not post to real WhatsApp, Instagram, Facebook or X. Official APIs require OAuth and can be added later.
            </p>
          </div>
        )}
      </main>
